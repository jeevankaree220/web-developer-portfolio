  ...
  return (
    <div className="relative bg-gray-50 h-screen">
      <Popover className="relative bg-white shadow">
        <div className="mx-auto max-w-full px-4 sm:px-6">
          <div className="flex items-center justify-between py-2 md:justify-start md:space-x-10">
            ...
            <div className="hidden items-center justify-end md:flex md:flex-1 lg:w-0 md:space-x-8">
              {/* <a href="#" className="underline whitespace-nowrap text-base font-medium text-gray-500 hover:text-gray-900">
                Marketing
              </a> */}
              <Link href="/projects" className="underline whitespace-nowrap text-base font-medium text-gray-500 hover:text-gray-900">
                Projects
              </Link>
              <Link href="/blog" className="underline whitespace-nowrap text-base font-medium text-gray-500 hover:text-gray-900">
                Blogs
              </Link>
              <Link
                href="/snippets"
                className="ml-8 inline-flex items-center justify-center whitespace-nowrap rounded-md border border-transparent bg-slate-700 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-indigo-700"
              >
                Free Code Snippets 😃
              </Link>
            </div>
      ...
      <main className="lg:relative">
        <div className="mx-auto w-full max-w-full pt-16 pb-20 text-center lg:py-48 lg:text-left">
          <div className="px-4 sm:px-8 lg:w-1/2 xl:pr-16">
            <h1 className="text-3xl font-bold tracking-tight text-slate-800 sm:text-4xl md:text-5xl lg:text-5xl xl:text-5xl flex items-center space-x-3">
              <span className="block xl:inline ">Hey, I am </span>{' '}
              <span className="block text-slate-800 bg-yellow-400 rounded-2xl px-2 sm:px-6 py-1 sm:py-3 xl:inline font-pacifico font-normal">Jeevan Karee</span>
              {/* <span className="block text-slate-800 bg-yellow-300 rounded-2xl px-2 py-1 xl:inline">&lt;Jeevan Karee&gt;</span> */}
            </h1>
            <p className="text-left mt-3 max-w-md text-lg text-gray-500 sm:text-xl md:mt-5 md:max-w-3xl">
              I am a Web Developer, highly experienced in building custom web applications. I have 7+ years of experience working in B2B SaaS Startups 🚀
            ...
            <div className="mt-10 sm:flex sm:justify-center lg:justify-start">
              <div className="rounded-md shadow">
                <button
                  ...
                  className="flex w-full items-center justify-center rounded-md border border-transparent bg-[#007bb5] px-4 py-3 text-base font-medium text-white md:py-2 md:px-4 md:text-lg"
                >
              ...
              <div className="mt-3 rounded-md shadow sm:mt-0 sm:ml-3">
                <a
                  href="#"
                  className="flex w-full items-center justify-center rounded-md border border-transparent bg-[#55ACEE] px-4 py-3 text-base font-medium text-white md:py-2 md:px-4 md:text-lg"
                >
              ...
              <div className="mt-3 rounded-md shadow sm:mt-0 sm:ml-3">
                <a target="_blank" rel="noopener noreferrer"
                  ...
                  className="flex w-full items-center justify-center rounded-md border border-transparent bg-slate-800 px-4 py-3 text-base font-medium text-white md:py-2 md:px-4 md:text-lg"
                >
        ...
        <div className="relative h-64 flex items-center w-full sm:h-full md:h-full lg:absolute lg:inset-y-0 lg:right-0 lg:h-full lg:w-1/2 bg-yellow-50">
          <img
            ...
            src="/images/jeevan-portfolio-image.png"
            alt=""
          />
